...
import { BANK_ACCOUNTS } from "../../constants/counterparties.js";
...
export default function TabCommandCenter({ rates, clockData, historicalRates, cashFlowHistory, paymentStreams }) {
