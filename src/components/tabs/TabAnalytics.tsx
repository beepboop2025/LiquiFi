...
import { PERF_METRICS } from "../../constants/performance";
...
export default function TabAnalytics(_props: TabAnalyticsProps) {
  const yieldBreakdownData = useMemo<YieldDataPoint[]>(
  ...
  const mapeTrendData = useMemo<MapeDataPoint[]>(
        ...
        <div className="card">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <BarChart data={yieldBreakdownData}>
              ...
              <YAxis tick={{ fill: "#475569", fontSize: 10, fontFamily: "JetBrains Mono" }} axisLine={false} tickLine={false} tickFormatter={(v: number) => `${v}bps`} />
              <Tooltip content={<Tt />} />
        ...
        <div className="card">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <AreaChart data={mapeTrendData}>
              ...
              <YAxis tick={{ fill: "#475569", fontSize: 10, fontFamily: "JetBrains Mono" }} axisLine={false} tickLine={false} tickFormatter={(v: number) => `${v}%`} domain={[0, 10]} />
              <Tooltip content={<Tt />} />
