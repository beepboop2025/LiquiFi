...
import { ERP_DATA } from "../../constants/erp.js";
import { resolveIcon } from "../../constants/iconMap.js";
import { generateMonteCarloSims } from "../../generators/monteCarlo.js";
import SectionTitle from "../shared/SectionTitle.jsx";
import StatBox from "../shared/StatBox.jsx";
import Tt from "../shared/Tt.jsx";

export default function TabAIEngine({ clockData, cashFlowHistory, mcData }) {
  const [localPaths] = useState(() => generateMonteCarloSims());
  const mcPaths = useMemo(() => mcData?.paths || localPaths, [mcData, localPaths]);
  const mcFlat = useMemo(() => mcPaths.flat(), [mcPaths]);
      ...
      <div className="card">
        ...
        <div style={{ display: "flex", gap: 14 }}>
          {ERP_DATA.upcoming.map((ev, i) => {
            const Icon = resolveIcon(ev.icon) || Calendar;
            return (
