...
import { ACCESS_ROLES } from "../../constants/access.js";
import { formatLatency, formatUptime } from "../../utils/formatters.js";
import SectionTitle from "../shared/SectionTitle.jsx";
import StatBox from "../shared/StatBox.jsx";

export default function TabSettings({ backend, onToggleKillSwitch, onToggleFailover, onResetCircuit }) {
  return (
