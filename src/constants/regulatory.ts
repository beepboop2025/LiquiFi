...
export const RBI_POLICY_RATES: RbiPolicyRates = {
  repo: 5.25,
  sdf: 5.00,
  msf: 5.50,
  bankRate: 5.50,
...
export const DEMO_CRR_SLR: CrrSlrPosition = {
  ndtl: 75000,
  crr: {
    rate: 3.00,
    required: 2250,
...
export const DEMO_CRR_HISTORY: CrrHistoryPoint[] = Array.from({ length: 30 }, (_, i) => {
  const base = 2250;
...
export const DEMO_SLR_HISTORY: CrrHistoryPoint[] = Array.from({ length: 30 }, (_, i) => {
  const base = 13500;
...
export const DEMO_ALM_DATA: AlmBucket[] = [
...
export const RBI_ALM_LIMITS: Record<string, AlmLimit> = {
...
export const DEMO_LCR_NSFR: LcrNsfr = {
  lcr: {
    hqlaLevel1: 9200,
    hqlaLevel2: 1800,
    totalHqla: 11000,
