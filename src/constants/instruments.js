export const EXEC_INSTRUMENTS = ["CBLO", "Call Money", "O/N Repo", "Liquid MMF", "T-Bill 91D", "Notice Money 7D", "CD 3M", "CP 1M"];
export const EXEC_SIDES = ["LEND", "BORROW"];

export const DEPLOYMENT_PORTFOLIO = [
