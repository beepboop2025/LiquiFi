import { rand, randInt, randIntInclusive } from '../utils/math.js';

export const PAYMENT_STREAMS = Array.from({ length: 20 }, (_, i) => ({
...
export const ORDER_BOOK = Array.from({ length: 15 }, (_, i) => ({
