 ...
 * @param {Object} [prev] - Previous rates snapshot for drift calculation
 * @returns {Object} New rates snapshot with all money market instrument rates
 */
export const generateRates = (prev) => {
